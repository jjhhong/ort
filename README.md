...
* [_Downloader_](#downloader) - fetches all source code referred by the projects, abstracting which Version Control
  System or other means are used to retrieve the source code.
